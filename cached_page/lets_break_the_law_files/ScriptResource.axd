...
Sys.Res={
"urlMustBeLessThan1024chars":"此記錄狀態必須小到能讓 URL 大於 1024 個字元。",
"argumentTypeName":"值不是現有型別的名稱。",
"methodRegisteredTwice":"方法 {0} 已經註冊過了。",
"cantSetIdAfterInit":"無法在初始設定之後在此物件上設定 ID 屬性。",
...
"typeShouldBeTypeOrString":"值不是有效的型別或有效的型別名稱。",
"historyInvalidHistorySettingCombination":"無法在 ScriptManager.EnableHistory 為 true 時將 enableHistory 設定為 false。",
...
"namespaceContainsObject":"物件 {0} 已經存在而且不是命名空間。",
...
"appComponentMustBeInitialized":"元件必須先初始化然後再加入到 Application 物件。",
"baseNotAClass":"值不是類別。",
...
"historyMissingHiddenInput":"如果要讓記錄功能在 Safari 2 中運作，此頁面必須有 ID 為 \u0027__history\u0027 的隱藏輸入項目。",
...
"scriptLoadMultipleCallbacks":"指令碼 \u0027{0}\u0027 包含多個 Sys.Application.notifyScriptLoaded() 的呼叫。只允許有一個。",
"invokeCalledTwice":"無法呼叫 Invoke 一次以上。",
"webServiceFailed":"伺服器方法 \u0027{0}\u0027 失敗，發生下列錯誤: {1}",
"webServiceInvalidJsonWrapper":"伺服器方法 \u0027{0}\u0027 傳回了無效的資料。JSON 包裝函式遺漏 \u0027d\u0027 屬性。",
"argumentType":"物件無法轉換為要求的型別。",
"argumentNull":"值不能為 null。",
"controlCantSetId":"ID 屬性不可在控制項上設定。",
